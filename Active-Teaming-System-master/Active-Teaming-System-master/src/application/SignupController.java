...
public class SignupController {
    ...
    void Signup_Click(ActionEvent event)throws IOException {
    	if (ValidateFields()) {
        	...
        	if (Referer.getText().equals("Qi Chen")  || Referer.getText().equals( "Jing Qian") || Referer.getText().equals("Diao Mao") ||  Referer.getText().equals("Xin Chen") )
        	{
        		SU_Event register_info = new SU_Event(Firstname.getText(),Lastname.getText(),Interest.getText(),Referer.getText(),Email.getText());
        		...
        		alert.setTitle("Information");	
            	alert.setHeaderText("Registration Incompleted");
            	alert.setContentText("Please enter the right Referer, and make sure there is no format error");
            	if (alert.getResult() == ButtonType.OK) {
                	MoveToLoginPage(event);
            	}	
            	alert.showAndWait();
